...
from handlers.handlers import cmd_start, cmd_startchat, cmd_stopchat, cmd_stopwaiting, chat
bot = Bot(token=token)
...
dp.register_message_handler(cmd_stopwaiting, commands=['stopwaiting'])
